...
| ID | Slug | Track | Model | Effort | Thinking | Depends | Status |
|:--:|---|:--:|:--:|:--:|:--:|:--:|:--:|
| 22 | [nsf-rename-to-dvdcompare-tmdb](22_nsf-rename-to-dvdcompare-tmdb.md) — rename existing `nameSpecialFeatures` → `nameSpecialFeaturesDvdCompareTmdb`; **code unchanged** | srv+web | Sonnet | Medium | ON | 21 | in-progress |
