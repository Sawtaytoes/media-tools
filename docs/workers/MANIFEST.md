...
| 23 | [nameMovieCutsDvdCompareTmdb-new-command](23_namemoviecuts-dvdcompare-tmdb-new-command.md) — new command: rename movies + move into directories by edition. Uses TMDB + DVD Compare | srv+web+cli | Sonnet | High | ON | 22, 35, 3a | in-progress |
