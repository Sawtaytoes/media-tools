...
| 2a | [server-template-storage](2a_server-template-storage.md) — file-backed `/api/templates` CRUD + web sidebar; templates become the canonical reusable form, URL query stays as the share-this-instance mechanism | srv+web | Sonnet | High | ON | 01 | in-progress |
