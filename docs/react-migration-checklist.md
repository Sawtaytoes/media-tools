...
| W7E | 7 — SubtitleRulesField default-rules preview section | ✅ Done | 2026-05-11 | Sonnet medium. Restored collapsible amber read-only preview above user rules: 3-rule DEFAULT_RULES_PREVIEW (setScriptInfo×2 + setStyleFields), useState(true) toggle, RuleCard isReadOnly=true. 3 new tests (render/hide/collapse). 364/364 tests, typecheck clean, lint 0 new errors. |
...
| W7E | 2026-05-11 | chore(checklist): W7E ✅ Done |
