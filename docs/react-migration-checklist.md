...
| W5A | 5 — Parity-trap + code-smell + a11y cleanup + page stories | 🔄 In Progress | 2026-05-11 | Sonnet high effort. Prompt: [react-migration-prompts/W5A.md](react-migration-prompts/W5A.md). Runs on **main checkout** on `react-migration`. Parallel with W5B. 4 streams: parity quirks (JsonField + 4 bridge atoms + MDX prose), code-smell sweep, a11y pass, page-level Storybook stories. Plus buildBuilderUrl format audit. (Was W5/W6 in earlier docs.) |
