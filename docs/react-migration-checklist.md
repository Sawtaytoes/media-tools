...
| W6B | 6 — Replace SortableJS with @dnd-kit (React-native DnD) | 🔄 In Progress | 2026-05-11 | claude-sonnet-4-6 medium. Worktree `.claude/worktrees/w6b`, branch `feat/dnd-kit-migration`. Pattern (a): direct composition at consumers; dropping `useDragAndDrop` hook. |
