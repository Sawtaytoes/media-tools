...
export function removeWhenClause({
  stepId,
  ruleIndex,
  clauseName,
}) {
...
export function setWhenClauseRef({
  ...
  setWhenSlot({
    ...
    mutator: (when) => {
      ...
      return {
        ...when,
        [clauseName]: compactWhenClause(nextClause) ?? {
          matches: {},
          excludes: null,
        },
      }
...
function setApplyIfSlot({
  ...
  commitRules({
    ...
    nextRules: updateRuleAt({
      ...
      ruleIndex,
      updater: (rule) => {
        const applyIf = isPlainObject(rule.applyIf)
          ? rule.applyIf
          : {}
...
export function addApplyIfClause({
  stepId,
  ruleIndex,
  clauseName,
}) {
...
export function removeApplyIfClause({
  stepId,
  ruleIndex,
  clauseName,
}) {
...
export function addApplyIfEntry({
  stepId,
  ruleIndex,
  clauseName,
}) {
