...
!((e, t) => {
  ...
  var n = {
    ...
    isNegativeZero: (e) =>
      0 === e && Number.NEGATIVE_INFINITY === 1 / e,
    extend: (e, t) => {
      var n, i, r, o
      if (t)
        for (
          n = 0, i = (o = Object.keys(t)).length;
          n < i;
          n += 1
        )
          e[(r = o[n])] = t[r]
  ...
  var c = (e, t) => {
      ...
      t.maxLength || (t.maxLength = 79),
        ...
        "number" !== typeof t.linesBefore &&
          (t.linesBefore = 3),
        "number" !== typeof t.linesAfter &&
          (t.linesAfter = 2)
      for (
        var i, r = /\r?\n|\r|\0/g, o = [0], c = [], s = -1;
        (i = r.exec(e.buffer));
  ...
  var p = function (e, t) {
    if (
      ...
      (this.resolve = t.resolve || (() => !0)),
      (this.construct = t.construct || ((e) => e)),
  ...
  d.prototype.extend = function (e) {
    ...
    if (e instanceof p) n.push(e)
      ...
      if (
        !e ||
        (!Array.isArray(e.implicit) &&
          !Array.isArray(e.explicit))
      )
        throw new o(
    ...
    return (
      ...
      (i.compiledTypeMap = (function () {
        ...
        function i(e) {
          e.multi
            ? (n.multi[e.kind].push(e),
              n.multi.fallback.push(e))
  ...
  var v = new p("tag:yaml.org,2002:bool", {
    ...
    represent: {
      lowercase: (e) => (e ? "true" : "false"),
      uppercase: (e) => (e ? "TRUE" : "FALSE"),
      camelcase: (e) => (e ? "True" : "False"),
    },
    defaultStyle: "lowercase",
  })
  function w(e) {
  ...
  var S = /^[-+]?[0-9]+e/
  var O = new p("tag:yaml.org,2002:float", {
      kind: "scalar",
      resolve: (e) =>
        null !== e &&
        !(!I.test(e) || "_" === e[e.length - 1]),
      construct: (e) => {
        var t, n
        return (
          (n =
      ...
      represent: (e, t) => {
        ...
        return (
          (i = e.toString(10)),
          S.test(i) ? i.replace("e", ".e") : i
        )
      },
      defaultStyle: "lowercase",
    }),
    j = b.extend({ implicit: [A, v, x, O] }),
    T = j,
    N =
      /^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$/,
    F =
      /^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\.([0-9]*))?(?:[ \t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$/
  var E = new p("tag:yaml.org,2002:timestamp", {
    kind: "scalar",
    resolve: (e) =>
      null !== e &&
      (null !== N.exec(e) || null !== F.exec(e)),
    construct: (e) => {
      var t,
        n,
        i,
        ...
        u = null
      if (
        (null === (t = N.exec(e)) && (t = F.exec(e)),
        null === t)
      )
        throw new Error("Date resolve error")
      if (
        ((n = +t[1]), (i = +t[2] - 1), (r = +t[3]), !t[4])
      )
  ...
  var M = new p("tag:yaml.org,2002:merge", {
      kind: "scalar",
      resolve: (e) => "<<" === e || null === e,
    }),
    L =
      "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=\n\r"
  var _ = new p("tag:yaml.org,2002:binary", {
      kind: "scalar",
      resolve: (e) => {
        if (null === e) return !1
        var t,
  ...
  var R = new p("tag:yaml.org,2002:pairs", {
      kind: "sequence",
      resolve: (e) => {
        if (null === e) return !0
        var t,
        ...
        for (
          ...
          if (((i = a[t]), "[object Object]" !== Y.call(i)))
            return !1
  ...
  var K = new p("tag:yaml.org,2002:set", {
      kind: "mapping",
      resolve: (e) => {
        if (null === e) return !0
        var t,
          n = e
        for (t in n)
          if (B.call(n, t) && null !== n[t]) return !1
        return !0
      },
      construct: (e) => (null !== e ? e : {}),
    }),
  ...
  for (
    var le = new Array(256), ce = new Array(256), se = 0;
    se < 256;
    se++
  )
    (le[se] = re(se) ? 1 : 0), (ce[se] = re(se))
  function ue(e, t) {
    ;(this.input = e),
      (this.filename = t.filename || null),
      (this.schema = t.schema || P),
  ...
  function de(e, t) {
    e.onWarning?.call(null, pe(e, t))
  }
  var he = {
    YAML: (e, _t, n) => {
      var i, r, o
      null !== e.version &&
        fe(e, "duplication of %YAML directive"),
        1 !== n.length &&
          fe(
            e,
        ...
        1 !== o &&
          2 !== o &&
          de(e, "unsupported YAML version of the document")
    },
    TAG: (e, _t, n) => {
      var i, r
      2 !== n.length &&
    ...
    if (t < n) {
      if (((l = e.input.slice(t, n)), i))
        for (r = 0, o = l.length; r < o; r += 1)
          9 === (a = l.charCodeAt(r)) ||
            (32 <= a && a <= 1114111) ||
            fe(e, "expected valid JSON character")
      else
        H.test(l) &&
          fe(
            e,
  ...
  function ye(e, t, n, i, r, o, a, l, c) {
    ...
    if (Array.isArray(r))
      for (
        s = 0,
          u = (r = Array.prototype.slice.call(r)).length;
        s < u;
        s += 1
      )
        Array.isArray(r[s]) &&
  ...
  function be(e) {
    ...
    10 === (t = e.input.charCodeAt(e.position))
      ...
      : 13 === t
        ? (e.position++,
          10 === e.input.charCodeAt(e.position) &&
            e.position++)
        : fe(e, "a line break is expected"),
      (e.line += 1),
  ...
  function Ae(e, t, n) {
    for (
      var i = 0, r = e.input.charCodeAt(e.position);
      0 !== r;
    ) {
      for (; z(r); )
        9 === r &&
  ...
  function ve(e) {
    ...
    return !(
      ...
      ((n += 3), 0 !== (t = e.input.charCodeAt(n)) && !X(t))
    )
  }
  function we(e, t) {
    1 === t
  ...
  function ke(e, t) {
    ...
    for (
      ...
      45 === i) &&
      X(e.input.charCodeAt(e.position + 1));
    )
      if (
        ((l = !0),
        e.position++,
        Ae(e, !0, -1) && e.lineIndent <= t)
      )
  ...
  function Ce(e) {
    ...
    if (
      (null !== e.tag &&
        fe(e, "duplication of a tag property"),
    ...
    i &&
      !Z.test(i) &&
      fe(e, `tag name cannot contain such characters: ${i}`)
    try {
  ...
  function xe(e) {
    ...
    for (
      null !== e.anchor &&
        fe(e, "duplication of an anchor property"),
    ...
    if (
        ...
        1 === g
          ? (c &&
            ...
            ((e, t) => {
              ...
              if (
                91 === (d = e.input.charCodeAt(e.position))
              )
                (a = 93), (s = !1), (o = [])
              else {
                if (123 !== d) return !1
              ...
              for (
                ...
                h
                  ...
                  (!c && e.line !== n) ||
                    ...
                    (f = e.result)),
                  s
                    ? ye(e, o, y, p, u, f, n, i, r)
                    : l
                      ? o.push(
                          ye(e, null, y, p, u, f, n, i, r),
                        )
                      : o.push(u),
                  Ae(e, !0, t),
                  44 ===
      ...
      if (W.call(e.typeMap[e.kind || "fallback"], e.tag))
        ...
        for (
          f = null,
            s = 0,
            u = (p = e.typeMap.multi[e.kind || "fallback"])
              .length;
          s < u;
          s += 1
        )
          if (
            e.tag.slice(0, p[s].tag.length) === p[s].tag
          ) {
            f = p[s]
            break
          }
      f || fe(e, `unknown tag !<${e.tag}>`),
        null !== e.result &&
          f.kind !== e.kind &&
          fe(
            e,
            `unacceptable node kind for !<${e.tag}> tag; it should be "${f.kind}", not "${e.kind}"`,
          ),
  ...
  function Se(e) {
    ...
    for (
      ...
      for (
        ...
        for (; z(r); ) r = e.input.charCodeAt(++e.position)
        if (35 === r) {
          do {
            r = e.input.charCodeAt(++e.position)
          } while (0 !== r && !Q(r))
      ...
      0 !== r && be(e),
        W.call(he, n)
          ? he[n](e, n, i)
          : de(e, `unknown document directive "${n}"`)
    }
    Ae(e, !0, -1),
      0 === e.lineIndent &&
      ...
      45 === e.input.charCodeAt(e.position + 2)
        ...
        : a && fe(e, "directives end mark is expected"),
      Ie(e, e.lineIndent - 1, 4, !1, !0),
      Ae(e, !0, -1),
      e.checkLineBreaks &&
        $.test(e.input.slice(o, e.position)) &&
        de(
          e,
  ...
  function Oe(e, t) {
    ...
    for (
      -1 !== i &&
        ((n.position = i),
        fe(n, "null byte is not allowed in input")),
        n.input += "\0";
      32 === n.input.charCodeAt(n.position);
    )
      (n.lineIndent += 1), (n.position += 1)
    for (; n.position < n.length - 1; ) Se(n)
    return n.documents
  }
  var je = {
      loadAll: (e, t, n) => {
  ...
  function Re(e) {
    return (
      ...
      (161 <= e &&
        ...
        8232 !== e &&
        8233 !== e) ||
      (57344 <= e && e <= 65533 && e !== Fe) ||
      (65536 <= e && e <= 1114111)
    )
  }
  function Be(e) {
    return Re(e) && e !== Fe && 13 !== e && 10 !== e
  }
  function Ke(e, t, n) {
    var i = Be(e),
      r = i && !Ye(e)
    ...
    e.dump = (() => {
      ...
      switch (
        ...
        case 2:
          return `'${t.replace(/'/g, "''")}'`
        case 3:
          return `|${Ge(t, e.indent)}${Ve(Ue(t, a))}`
        case 4:
          return `>${Ge(t, e.indent)}${Ve(
            Ue(
              ((e, t) => {
                var n,
                  i,
  ...
  function Je(e, t, n, i) {
    ...
    for (r = 0, o = n.length; r < o; r += 1)
      (a = n[r]),
        e.replacer &&
          (a = e.replacer.call(n, String(r), a)),
        (ze(e, t + 1, a, !0, !0, !1, !0) ||
          (void 0 === a &&
            ze(e, t + 1, null, !0, !0, !1, !0))) &&
          ((i && "" === l) || (l += qe(e, t)),
  ...
  function Qe(e, t, n) {
    ...
    for (
      a = 0,
        l = (r = n ? e.explicitTypes : e.implicitTypes)
          .length;
      a < l;
      a += 1
    )
      if (
        ...
        if (
          ...
          if (
            ...
            "[object Function]" === Te.call(c.represent))
          )
            i = c.represent(t, s)
          else {
            if (!Ne.call(c.represent, s))
              throw new o(
    ...
    if (
      ...
      if (
        ...
        if ("[object String]" !== s) {
          ...
          throw new o(
            `unacceptable kind of an object to dump ${s}`,
          )
        }
        "?" !== e.tag && $e(e, e.dump, t, a, u)
      }
      null !== e.tag &&
        "?" !== e.tag &&
        ((c = encodeURI(
  ...
  function Xe(e, t) {
    var n,
      ...
      r = [],
      o = []
    for (et(e, r, o), n = 0, i = o.length; n < i; n += 1)
