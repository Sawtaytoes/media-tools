...
!((t, e) => {
    ...
    return (a =
      ...
      function (t) {
        for (var e = 1; e < arguments.length; e++) {
          var n,
            o = arguments[e]
          for (n in o) Object.hasOwn(o, n) && (t[n] = o[n])
        }
        return t
      ...
      if (
        ...
        do {
          if (
            ...
            ;(a -=
              h.top +
              parseInt(R(i, "border-top-width"), 10)),
              (l -=
                h.left +
                parseInt(R(i, "border-left-width"), 10)),
              (s = a + r.height),
              (c = l + r.width)
            break
          }
  ...
  function M(t, e) {
    if (!t?.getBoundingClientRect) return O()
    var n = t,
      o = !1
    do {
      if (
    ...
    return (
      Array.from(n.children).forEach((t) => {
        ...
        P(t, o.draggable, n, !1) &&
          ...
          (r.right = Math.max(
            null !== (t = r.right) && void 0 !== t
              ? t
              : -1 / 0,
            e.right,
          )),
          (r.bottom = Math.max(
            null !== (t = r.bottom) && void 0 !== t
              ? t
              : -1 / 0,
            e.bottom,
          )))
      ...
      captureAnimationState: function () {
        ;(o = []),
          this.options.animation &&
            [].slice.call(this.el.children).forEach((t) => {
              var e, n
              "none" !== R(t, "display") &&
                t !== Ft.ghost &&
        ...
        o.forEach((t) => {
          ...
          s && ((i.top -= s.f), (i.left -= s.e)),
            ...
            D(i, o) ||
              ((n.prevFromRect = o),
              (n.prevToRect = i),
              (e = e || this.options.animation),
              this.animate(n, l, i, e)),
            e &&
              ((u = !0),
              (d = Math.max(d, e)),
              clearTimeout(n.animationResetTimer),
              (n.animationResetTimer = setTimeout(() => {
                ;(n.animationTime = 0),
                  (n.prevFromRect = null),
                  (n.fromRect = null),
                  (n.prevToRect = null),
  ...
  var A = [],
    ...
    W = {
      mount: (e) => {
        for (var t in N)
          !Object.hasOwn(N, t) || t in e || (e[t] = N[t])
        A.forEach((t) => {
      ...
      pluginEvent: function (e, n, o) {
        ...
        A.forEach((t) => {
          n[t.pluginName] &&
            (n[t.pluginName][i] &&
              n[t.pluginName][i](I({ sortable: n }, o)),
            n.options[t.pluginName] &&
              n[t.pluginName][e] &&
              n[t.pluginName][e](I({ sortable: n }, o)))
        })
      },
      initializePlugins: function (n, o, i, _t) {
        for (var e in (A.forEach((t) => {
          var e = t.pluginName
        ...
        n.options)) {
          var r
          Object.hasOwn(n.options, e) &&
            void 0 !==
              (r = this.modifyOption(n, e, n.options[e])) &&
            (n.options[e] = r)
        }
      },
        ...
        return (
          A.forEach((t) => {
            "function" === typeof t.eventProperties &&
              a(
                o,
                t.eventProperties.call(n[t.pluginName], e),
              )
          }),
          o
        )
  ...
  function z(_t) {
    ...
    if ((e = e || n?.[K])) {
      ...
      !window.CustomEvent || y || w
        ? (g = document.createEvent("Event")).initEvent(
            o,
            !0,
            !0,
          )
      ...
      for (v in b) g[v] = b[v]
      n?.dispatchEvent(g), m[t]?.call(e, g)
    }
  }
  function G(t, e) {
    var n = (o =
  ...
  var V,
    ...
    Pt = (_t, e) => {
      var n = R(t),
        o =
          parseInt(n.width, 10) -
          parseInt(n.paddingLeft, 10) -
          parseInt(n.paddingRight, 10) -
          parseInt(n.borderLeftWidth, 10) -
          parseInt(n.borderRightWidth, 10),
        i = B(t, 0, e),
        r = B(t, 1, e),
        a = i && R(i),
        l = r && R(r),
  ...
  function Yt(t) {
    if (V) {
      ...
      if (e) {
        var n,
          o = {}
        for (n in t) Object.hasOwn(t, n) && (o[n] = t[n])
        ;(o.target = o.rootEl = e),
  ...
  function Bt(t) {
    V?.parentNode[K]._isOutsideThisEl(t.target)
  }
  function Ft(t, e) {
    ...
    var n,
      ...
      i = {
        ...
        store: null,
        handle: null,
        draggable: /^[uo]l$/i.test(t.nodeName)
          ? ">li"
          : ">*",
        swapThreshold: 1,
        invertSwap: !1,
  ...
  ;(Ft.prototype = {
    ...
    _prepareDragStart: function (t, e, n) {
      ...
      n &&
        ...
        a.ignore.split(",").forEach((t) => {
          b(V, t.trim(), Ht)
        }),
        h(l, "dragover", Yt),
        h(l, "mousemove", Yt),
        h(l, "touchmove", Yt),
        h(l, "mouseup", this._onDrop),
        h(l, "touchend", this._onDrop),
        h(l, "touchcancel", this._onDrop),
        s &&
          this.nativeDraggable &&
        ...
        (this.nativeDraggable && (w || y))
          ...
          : Ft.eventCanceled
            ? this._onDrop()
            : (h(l, "mouseup", this._disableDelayedDrag),
              h(l, "touchend", this._disableDelayedDrag),
              h(l, "touchcancel", this._disableDelayedDrag),
              h(
                l,
                "mousemove",
    ...
    _triggerDragStart: function (t, e) {
      ;(e = e || ("touch" === t.pointerType && t)),
        !this.nativeDraggable || e
          ...
          : (h(V, "dragend", this),
            h(Q, "dragstart", this._onDragStart))
      try {
        document.selection
          ? Kt(() => {
    ...
    _emulateDragOver: function () {
      if (ut) {
        ;(this._lastX = ut.clientX),
          (this._lastY = ut.clientY),
          Rt()
        for (
    ...
    _appendGhost: function () {
      if (!$) {
        var t = this.options.fallbackOnBody
            ? document.body
            : Q,
          e = X(V, !0, Mt, !0, t),
          n = this.options
        ...
        k(($ = V.cloneNode(!0)), n.ghostClass, !1),
          ...
          R(
            $,
            "transform-origin",
            `${(ft / parseInt($.style.width, 10)) * 100}% ${(pt / parseInt($.style.height, 10)) * 100}%`,
          )
      }
    },
        ...
        Ft.eventCanceled
          ...
          : (G("setupClone", this),
            ...
            e
              ...
              : (f(document, "mouseup", this._onDrop),
                f(document, "touchend", this._onDrop),
                f(document, "touchcancel", this._onDrop),
                o &&
                  ((o.effectAllowed = "move"),
                  i.setData?.call(this, o, V)),
                h(document, "drop", this),
                R(V, "transform", "translateZ(0)")),
            (wt = !0),
            (this._dragStartId = Kt(
              this._dragStarted.bind(this, e, t),
            )),
      ...
      function _A(t) {
        return (
          ...
          s.dragoverBubble ||
            n.rootEl ||
            l === document ||
            (V.parentNode[K]._isOutsideThisEl(n.target),
            t || Yt(n)),
          !s.dragoverBubble &&
            n.stopPropagation &&
            n.stopPropagation(),
        ...
        Ft.eventCanceled ||
          ...
          t &&
            ...
            V &&
              ...
              gt &&
                !wt &&
                k(V, (st || this).options.ghostClass, !1),
    ...
    (Ft.mount = function () {
      for (
        ...
        e[n] = arguments[n]
      ;(e = e[0].constructor === Array ? e[0] : e).forEach(
        (t) => {
          ...
          t.utils &&
            (Ft.utils = I(I({}, Ft.utils), t.utils)),
            W.mount(t)
        },
      )
    }),
    (Ft.create = (t, e) => new Ft(t, e))
  var zt,
    Gt,
    Ut,
    qt,
            ...
            (0 === T && 0 === p) ||
              ...
              ($t[d].pid = setInterval(
                function () {
                  o &&
                    0 === this.layer &&
                    Ft.active._onTouchMove(Vt)
                  var t = $t[this.layer].vy
                      ? $t[this.layer].vy * s
                      : 0,
                    e = $t[this.layer].vx
                      ? $t[this.layer].vx * s
      ...
      new (function () {
        ...
        return (
          (t.prototype = {
              ...
              if (this.isMultiDrag) {
                for (var n = 0; n < ue.length; n++)
                  de.push(_(ue[n])),
                    ...
                    ue[n] === le &&
                      k(de[n], this.options.chosenClass, !1)
                e._hideClone(), t()
              }
            },
            clone: function (_t) {
            ...
            hideClone: function (_t) {
              var n = (t.sortable, t.cloneNowHidden),
                t = t.cancel
              this.isMultiDrag &&
                (de.forEach((t) => {
                  R(t, "display", "none"),
            ...
            dragStartGlobal: function (t) {
              ...
              !this.isMultiDrag &&
                ae &&
                ae.multiDrag._deselectMultiDrag(),
                ue.forEach((t) => {
                  t.sortableIndex = j(t)
                }),
                (ue = ue.sort(
                  (t, e) =>
                    t.sortableIndex - e.sortableIndex,
                )),
                (pe = !0)
            },
            dragStarted: function (_t) {
              var e,
                t = t.sortable
              this.isMultiDrag &&
                (this.options.sort &&
