...
import { replaceAttachments } from "../app-commands/replaceAttachments.js"
...
export const replaceAttachmentsCommand: CommandModule<{}, Args> = {
  command: "replaceAttachments <sourceFilesPath> <destinationFilesPath>",
