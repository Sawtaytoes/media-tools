...
const builder = (yargs: Argv) => (
  ...
  .option(
    "extensions",
    {
      array: true,
      demandOption: true,
      describe: "List of file extensions to delete (with or without leading dot).",
      type: "string",
    },
  )
  .option(
    "isRecursive",
    {
      ...
      boolean: true,
      default: false,
      describe: "Recursively search subdirectories for matching files.",
      nargs: 0,
      type: "boolean",
    },
  )
...
export const deleteFilesByExtensionCommand: CommandModule<{}, Args> = {
  command: "deleteFilesByExtension <sourcePath>",
  describe: "Delete files by extension from the provided directory.",
