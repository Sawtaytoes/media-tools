...
describe("StatusBadge", () => {
  ...
  it("applies pending styles", () => {
    render(<StatusBadge status="pending" />)
    expect(screen.getByText("pending").className).toContain("text-blue-300")
  })
  ...
  it("applies completed styles", () => {
    ...
    expect(screen.getByText("completed").className).toContain("text-emerald-400")
  })
  ...
  it("applies cancelled styles", () => {
    ...
    expect(screen.getByText("cancelled").className).toContain("text-slate-300")
  })
