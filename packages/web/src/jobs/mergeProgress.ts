...
export const mergeProgress = (
  ...
  if (event.bytesPerSecond !== undefined) merged.bytesPerSecond = event.bytesPerSecond
  if (event.bytesRemaining !== undefined) merged.bytesRemaining = event.bytesRemaining
