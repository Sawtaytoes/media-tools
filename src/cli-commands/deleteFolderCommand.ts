...
const builder = (yargs: Argv) => (
  ...
  .option(
    "confirm",
    {
      boolean: true,
      default: false,
      describe: "Required: pass --confirm to acknowledge this is destructive. Without it the command refuses to run.",
      type: "boolean",
    },
  )
)
...
export const deleteFolderCommand: CommandModule<{}, Args> = {
  ...
  describe: "Recursively delete a folder and all its contents. Useful for cleaning up scratch directories like ~TEMP/AUDIO-OFFSETS after running getAudioOffsets. Requires --confirm.",
