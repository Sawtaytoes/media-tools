...
export const isMissingSubtitlesCommand: CommandModule<{}, Args> = {
  command: "isMissingSubtitles <sourcePath>",
  describe: "Lists all folders and files where subtitles are missing. This is useful when you have a lot of media in a different language and may need to add subtitles.",
