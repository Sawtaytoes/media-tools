...
export const fixIncorrectDefaultTracksCommand: CommandModule<{}, Args> = {
  command: "fixIncorrectDefaultTracks <sourcePath>",
  describe: "Modifies each file such that the first track of each type is set as the default.",
