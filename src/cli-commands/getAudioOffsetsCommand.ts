...
export const getAudioOffsetsCommand: CommandModule<{}, Args> = {
  command: "getAudioOffsets <sourceFilesPath> <destinationFilesPath>",
  describe: "Get the audio offset of media files in two directories where files share the same name.",
