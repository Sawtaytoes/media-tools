...
export const moveFilesCommand: CommandModule<{}, Args> = {
  ...
  describe: "Copy all files from one directory to another, then delete the source directory. Equivalent to copyFiles followed by deleting the source. Useful when you want to clean up the output subdirectory after copying results back.",
