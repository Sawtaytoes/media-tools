...
export const hasBetterVersionCommand: CommandModule<{}, Args> = {
  command: "hasBetterVersion <sourcePath>",
  describe: "Output a list of Ultra HD Blu-ray releases where a better version is available along with a reason. This information comes from a thread on criterionforum.org.",
