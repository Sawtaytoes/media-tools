...
export const mergeOrderedChaptersCommand: CommandModule<{}, Args> = {
  command: "mergeOrderedChapters <sourcePath> [introFilename] [outroFilename]",
  describe: "Merges media files with ordered chapters and separate intro and outro files. Intro and outro files need to be named \"merge-intro.mkv\" and \"merge-outro.mkv\" respectively. NOTE: All FLAC audio tracks have to be converted to PCM first as MKVToolNix can't merge FLAC audio tracks.",
